export default function Delete() {
  return (
    ...
    >
      ...
      <path
        fill="#FFFFFF"
        d="M7,9.886L7,9.886C7,9.363,7.358,8.912,7.868,8.8C10.173,8.293,16.763,7,24,7s13.827,1.293,16.132,1.8	C40.642,8.912,41,9.363,41,9.886v0C41,10.FF,40.501,11,39.886,11H8.114C7.499,11,7,10.501,7,9.886z"
      />
    </svg>
  );
}
